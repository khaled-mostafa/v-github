export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: 'v-GitHub lets you to view GitHub users in instagram-like layout.' },
      { hid: 'keywords', name: 'keywords', content: 'GitHub, GitHub gram, githubgram'},
      { property: 'og:title', content: 'v-GitHub'},
      { property: 'og:description', content: 'v-GitHub lets you to view GitHub users in instagram-like layout.' },
